    ...
    return(
        <div>
            ...
            <div className="h-screen  main">
                ...
                <div className=" h-100  bg-[url('./src/assets/pexels-karoldach-409696.jpg')] bg-cover">
                    {/* <h1 className="text-white pt-4 text-center  text-3xl font-semibold">Plantify</h1> */}

                    <h2 className="text-white pt-25 text-center  text-xl font-semibold sm:text-3xl ">Try our AI Powerd <br></br> Disease Detection</h2>
                ...
                <div class="overlay"></div>
                <div className="  bg-gradient-to-t to-lime-500 sm:items-start h-full md:h-full from-black">
